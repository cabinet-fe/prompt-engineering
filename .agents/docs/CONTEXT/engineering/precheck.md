...
- **SMELLS.md**：代码类坏味道基线。setup 从技能包 `setup/references/smells.md` 原样复制到 `.agents/docs/SMELLS.md`；precheck 检查存在。
...
检查项只由 precheck.mjs 定义：各类都要根 AGENTS 与类别模板一致、PROJECT.md、CONTEXT/index.md、spec-files.mjs、cooking 目录、gitignore 忽略 cooking 且不忽略 docs/scripts。代码类还要 ARCHITECTURE / DEV-STANDARDS / CODE-MAP / SMELLS。没有 complete.md。副本过期靠重跑 setup。
...
- 2026-08-25：代码类必有 docs 增加 SMELLS.md；涉及：skills/engineering/setup/scripts/precheck.mjs、skills/engineering/setup/references/root-agents-code.md
