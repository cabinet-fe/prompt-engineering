...
- 2026-08-26：rush 优化 review 失败处理：单阶段 review 不通过时自动派发 implement 返工修复并重新 review（最多 3 轮闭环），避免直接终止；涉及：skills/engineering/rush/SKILL.md、skills/engineering/rush/references/subagent-prompts.md、skills/engineering/implement/SKILL.md、skills/engineering/review/SKILL.md
- 2026-08-27：setup 项目类别增加 App / 嵌入式 / 游戏，代码类由五类扩为八类；涉及：skills/engineering/setup/references/classify.md、skills/engineering/setup/references/templates.md
