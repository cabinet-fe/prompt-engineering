...
| spec-index | `skills/engineering/sync-spec/scripts/spec-files.mjs` | 扫描归档 spec「影响文件」的新增/修改，parse/query/list | `spec-files.mjs` |
...
- **规格反查**：`node .agents/scripts/spec-files.mjs query <变更文件...>`（扫描归档 spec 的「影响文件」），命中再打开对应 spec。
